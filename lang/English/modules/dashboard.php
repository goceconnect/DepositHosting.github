...
define('welcome_text', "Welcome to the Open Game Panel (OGP). Open Game Panel is an open source project, that allows you to start, monitor and install different game servers.");
