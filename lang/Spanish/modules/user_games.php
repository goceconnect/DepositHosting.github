...
define('control_password_info', "RCON password");
...
define('change_home_info', "Ejemplo: /home/ogp/my_server/");
define('game_server_name', "Nombre del servidor");
define('change_name_info', "Este nombre ayuda a identificar el servidor.");
define('game_control_password', "RCON");
define('change_control_password_info', "rcon password.");
...
define('nice_level', "Nivel de Nice");
...
define('port_range_error', "Puert entre 0 y 65535.");
