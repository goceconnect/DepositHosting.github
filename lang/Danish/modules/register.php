...
define('users_fname', "Fornavn");
define('users_lname', "Efternavn");
...
define('register_message', "Hejsa,
		 Din konto er nu oprettet.

		 Brugernavn: %s
		 Adgangskode: %s
		 
		 Du ka nu ændre din adgangskode til din konto.

		 På forhånd tak!
		 En administrator.

		 Denne email er bleven sendt automatisk, vær venlig ikke at svarer tilbage!");
...
define('subject', "Hejsa %s, velkommen til %s.");
?>