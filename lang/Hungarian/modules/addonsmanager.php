...
// Addons
define('install_plugin', "Plugin telepítés");
define('install_mappack', "Pálya csomag telepítés");
define('install_config', "Konfig telepítés");
define('game_name', "Játék név");
define('directory', "Könyvtár elérés");
