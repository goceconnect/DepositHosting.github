...
define('no_more_homes_available_that_can_be_assigned_for_this_group', "Il n'y a plus de serveur disponible pour cet utilisateur");
...
define('cloning_home', "Cloange du serveur '%s'");
