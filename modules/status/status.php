...
function exec_ogp_module()
{
	...
	if ($modulecpu == "1" and $nocpushow != "1") 
	{
		echo '<div id="column4" style="width:49.5%;float:right;margin-top:1%;" >
			   ...
			   <div class="dragbox-content">';
		$core_number = 0;
		foreach($cores as $cpupercent)
		{		 
			echo '<b>CPU' . $core_number . ' Load: ' . $cpupercent . ' %</b><br>
				  <img src="modules/status/include/bar.php?rating=' . $cpupercent . '" style="width:100%;border:1px solid tranparent;" />';
			$core_number++;
		}
