...
////set $id=2 on line 46 before uncomment custom ip ////

//$net2ftp_settings["allowed_ftpservers"][1] = "your_custom_ip"; 
$remote_servers = $_SESSION['remote_servers'];
$id = 1;
foreach($remote_servers as $remote_server)
{
	if($remote_server['ftp_ip'] == "")
	{
		$net2ftp_settings["allowed_ftpservers"][$id] = $remote_server['agent_ip'];
		$id++;
	}
	else
	{
		$net2ftp_settings["allowed_ftpservers"][$id] = $remote_server['ftp_ip'];
		$id++;
	}
}
//$net2ftp_settings["allowed_ftpservers"][2] = "ftp.mydomain.com";
//$net2ftp_settings["allowed_ftpservers"][3] = "192.168.1.1";
//$net2ftp_settings["allowed_ftpservers"][4] = "ftp.mydomain2.org";
