...
$net2ftp_messages["Logging into the FTP server"] = "Iniciando sesión";
...
$net2ftp_messages["This function has been disabled by the Administrator of this website."] = "Esta función a sido deshabilitada por el administrador del sitio web.";
...
$net2ftp_messages["OpenOffice - Draw 6.0 document"] = "OpenOffice - Documento Draw 6.0";
$net2ftp_messages["OpenOffice - Draw 6.0 template"] = "OpenOffice - Plantilla Draw 6.0";
$net2ftp_messages["OpenOffice - Impress 6.0 presentation"] = "OpenOffice - Presentación Impress 6.0";
...
$net2ftp_messages["StarOffice - StarImpress 5.x presentation"] = "StarOffice - Presentación StarImpress 5.x";
...
$net2ftp_messages["MOV movie file"] = "Película MOV";
$net2ftp_messages["MPEG movie file"] = "Película MPEG";
$net2ftp_messages["Real movie file"] = "Película Real";
$net2ftp_messages["Quicktime movie file"] = "Película Quicktime";
$net2ftp_messages["Shockwave flash file"] = "Película Flash Shockwave";
...
$net2ftp_messages["Connection settings:"] = "Configuración de la conexión:";
...
$net2ftp_messages["Closing the connection: "] = "Cerrando la conexión: ";
...
$net2ftp_messages["Troubleshoot your net2ftp installation"] = "Depurar tu instalación de net2ftp";
$net2ftp_messages["Printing the result"] = "Printing the result";
...
$net2ftp_messages["no - please install it!"] = "no - ¡por favor instálalo!";
...
// -------------------------------------------------------------------------
$net2ftp_messages["Add this link to your bookmarks:"] = "Arrastra este link a tus Favoritos:";
...
$net2ftp_messages["View the highlighted source code of file %1\$s"] = "Ver el código seleccionado del archivo %1\$s";
$net2ftp_messages["Edit the source code of file %1\$s"] = "Editar el código del archivo %1\$s";
...
$net2ftp_messages["This folder is empty"] = "El directorio esta vacío";
...
$net2ftp_messages["Directory Tree"] = "Árbol de directorios";
...
$net2ftp_messages["Set all permissions"] = "Cambiar todos los permisos";
...
$net2ftp_messages["Chmod also the subdirectories within this directory"] = "Dar permisos también los subdirectorios dentro de este directorio";
$net2ftp_messages["Chmod also the files within this directory"] = "Dar permisos también los archivos dentro de este directorio";
$net2ftp_messages["The chmod nr <b>%1\$s</b> is out of the range 000-777. Please try again."] = "El código de permiso <b>%1\$s</b> esta fuera del rango 000-777. Por favor intenta de nuevo.";
...
$net2ftp_messages["To set a common target directory, enter that target directory in the textbox above and click on the button \"Set all targetdirectories\"."] = "Para especificar un directorio destino común, escribe el nombre del directorio en el campo que esta arriba y haz clic en \"Especificar directorio destino común\".";
...
$net2ftp_messages["Please specify a filename"] = "Por favor especifique un nombre de archivo";
...
$net2ftp_messages["Restrict the search to:"] = "Restringir la búsqueda a:";
$net2ftp_messages["files with a filename like"] = "archivos con un nombre como";
$net2ftp_messages["(wildcard character is *)"] = "(el caracter comodín es *)";
...
$net2ftp_messages["Once you are logged in, you will be able to:"] = "Una vez iniciada la sesión, podrás ...";
$net2ftp_messages["Navigate the FTP server"] = "Navegar en el FTP server";
$net2ftp_messages["Once you have logged in, you can browse from directory to directory and see all the subdirectories and files."] = "Si has iniciado una sesión podrás ver tus directorios y archivos.";
$net2ftp_messages["Upload files"] = "Subir tus archivos";
$net2ftp_messages["There are 3 different ways to upload files: the standard upload form, the upload-and-unzip functionality, and the Java Applet."] = "Hay tres formas diferentes de subir archivos: la estandar, subir y comprimir, and mediante un java applet.";
$net2ftp_messages["Download files"] = "Descargar archivos";
$net2ftp_messages["Click on a filename to quickly download one file.<br />Select multiple files and click on Download; the selected files will be downloaded in a zip archive."] = "Hacer click en el nombre de archivo para su descarga instantánea.<br />Seleccionar varios archivos a la vez y pulsar en el botón de descarga; Los archivos seleccionados serán descargados en un archivo .zip.";
...
$net2ftp_messages["Directories are handled recursively, meaning that their content (subdirectories and files) will also be copied, moved or deleted."] = "El contenido de los subdirectories y los archivos también será copiado, movido o suprimido.";
...
$net2ftp_messages["PHP functions are linked to the documentation on php.net."] = "las funciones PHP están vinculadas a la documentación en php.net.";
$net2ftp_messages["Plain text editor"] = "Editor de texto plano";
$net2ftp_messages["Edit text right from your browser; every time you save the changes the new file is transferred to the FTP server."] = "Editar el texto desde tu explorador; siempre que guardes los cambios se transferirán al servidor FTP.";
...
$net2ftp_messages["Code editor"] = "Editor de código";
...
$net2ftp_messages["Search for words or phrases"] = "Búsqueda para las palabras o las frases";
$net2ftp_messages["Filter out files based on the filename, last modification time and filesize."] = "Filtrar los listados archivos basándose en el nombre de fichero, la vez pasada de la modificación y tamaño del archivo.";
$net2ftp_messages["Calculate size"] = "Calcular tamaño";
$net2ftp_messages["Calculate the size of directories and files."] = "Calcular el tamaño de directorios y archivos.";
...
$net2ftp_messages["Username"] = "Nombre de Usuario";
$net2ftp_messages["Password"] = "Contraseña";
$net2ftp_messages["Anonymous"] = "Anónimo";
$net2ftp_messages["Passive mode"] = "Modo pasivo";
...
$net2ftp_messages["Please enter an FTP server."] = "Por favor introduzca un servidor FTP.";
$net2ftp_messages["Please enter a username."] = "Por favor, introduzca un nombre de usuario.";
$net2ftp_messages["Please enter a password."] = "Por favor, introduzca una contraseña.";
...
$net2ftp_messages["Please enter your Administrator username and password."] = "Por favor introduzca su nombre de usuario y contraseña de administrador.";
...
$net2ftp_messages["Username"] = "Nombre de Usuario";
$net2ftp_messages["Your session has expired; please enter your password for FTP server <b>%1\$s</b> to continue."] = "Tu sesión a sido cancelada; por favor introduce tu contraseña para el servidor FTP <b>%1\$s</b> y continua.";
$net2ftp_messages["Your IP address has changed; please enter your password for FTP server <b>%1\$s</b> to continue."] = "Tu dirección IP a cambiado; Por favor introduzca su contraseña para el servidor FTP <b>%1\$s</b> para continuar.";
$net2ftp_messages["Password"] = "Contraseña";
$net2ftp_messages["Login"] = "Iniciar";
$net2ftp_messages["Continue"] = "Continue";
...
// logout.template.php
$net2ftp_messages["You have logged out from the FTP server. To log back in, <a href=\"%1\$s\" title=\"Login page (accesskey l)\" accesskey=\"l\">follow this link</a>."] = "Has cerrado tu sesión en el servidor FTP. Para entrar de nuevo a la pagina de inicio de sesion, <a href=\"%1\$s\" title=\"Login page (accesskey l)\" accesskey=\"l\">Click aquí</a>.";
...
$net2ftp_messages["Click here to close this window"] = "Click aquí para cerrar la ventana";
...
$net2ftp_messages["The maximum execution time is <b>%1\$s seconds</b>"] = "El tiempo máximo de ejecución es de <b>%1\$s segundos</b>";
$net2ftp_messages["The FTP transfer mode (ASCII or BINARY) will be automatically determined, based on the filename extension"] = "El modo de transferencia FTP (ASCII or BINARY) sera elegido automáticamente, basándose en la extensión del archivo";
$net2ftp_messages["If the destination file already exists, it will be overwritten"] = "Si el archivo ya existe, sera sobrescrito";
...
$net2ftp_messages["Files entered here will be transferred to the FTP server."] = "Los archivos seleccionados serán transferidos al servidor FTP.";
...
// -------------------------------------------------------------------------
$net2ftp_messages["Restrictions:"] = "Restricciones:";
$net2ftp_messages["The maximum size of one file is restricted by net2ftp to <b>%1\$s kB</b> and by PHP to <b>%2\$s</b>"] = "El tamaño máximo de un archivo esta restringido por net2ftp a <b>%1\$s kB</b> y por PHP a <b>%2\$s</b>";
$net2ftp_messages["The maximum execution time is <b>%1\$s seconds</b>"] = "El tiempo máximo de ejecución es de <b>%1\$s segundos</b>";
$net2ftp_messages["The FTP transfer mode (ASCII or BINARY) will be automatically determined, based on the filename extension"] = "El modo de transferencia FTP (ASCII or BINARY) sera elegido automáticamente, basándose en la extensión del archivo";
$net2ftp_messages["If the destination file already exists, it will be overwritten"] = "Si el archivo ya existe, sera sobrescrito";
...
$net2ftp_messages["View image %1\$s"] = "Ver imagen %1\$s";
$net2ftp_messages["View Macromedia ShockWave Flash movie %1\$s"] = "Ver película flash de tipo Macromedia ShockWave %1\$s";
...
$net2ftp_messages["Email the zip file in attachment to:"] = "Enviar el archivo comprimido por correo electrónico a:";
...
$net2ftp_messages["The email address you have entered (%1\$s) does not seem to be valid.<br />Please enter an address in the format <b>username@domain.com</b>"] = "La dirección de correo electrónico (%1\$s) no es valida.<br />Por favor especifica una dirección con el formato <b>usuario@dominio.com</b>";
